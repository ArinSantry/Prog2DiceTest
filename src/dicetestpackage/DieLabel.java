...
public class DieLabel extends JLabel {
    ...
    /**
     * Set icon of die.
     * @param value number of die
     * @return true if value of die is valid, false otherwise
     */
    ...
    /**
     * Check if die is clicked.
     * @param evt click mouse event
     */
    ...
    /**
     * set animation of die.
     * @param animationState is die animated or not
     */
    ...
    /**
     * Check if die is animated.
     * @return true if die is animated, false otherwise
     */
    ...
    /**
     * Hold die or release die.
     * @param holdState is die held or not
     */
     ...
     * @return true if die is being held, false otherwise
     */
